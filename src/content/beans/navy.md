...
goal: to hold the structure — does what's required
positiveTraits: [dependable, hard-working, dutiful, enduring, upright]
...
The Navy Bean's challenge is rigidity. A Bean that refuses to absorb new flavours just sits in the broth, unchanged and unchanging. The Navy Bean Year asks all Beans to ask whether the structure still serves its purpose — and to have the courage to rebuild what doesn't.
