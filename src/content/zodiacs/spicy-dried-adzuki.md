...
fortuneMost: A dry pan, one peppercorn, and the whole kitchen wakes up. You are the peppercorn.
fortuneMost2: Say the one sentence everyone's been circling. The circling stops the moment it lands.
fortuneHigh: Something stalled for weeks is about to move, and your name is the one that gets said when it does.
fortuneHigh2: A half-formed plan reaches you, and within the hour it has a date on it.
fortuneMid: Make the call you keep almost making. The nudge is small; the people aren't.
fortuneMid2: One plain question, asked out loud — the whole afternoon turns to follow it.
fortuneLow: Not every match is yours to strike. The fire you skip is one you won't be tending at midnight, though your hands will itch for it.
fortuneLow2: Hand the spark to someone who can stay near it. You lose the credit, but you were never going to keep that fire fed.
fortuneLeast: It catches on its own. It stings a little, how little it needed you — and that's a kind of rest.
fortuneLeast2: Some good news keeps better under the tongue a while. Let the thing find its own heat.
facetMostTitle: Peppercorn Under the Tongue
facetMost: Say the sentence nobody else will, the one that ends the hour-long stall — your mouth opens before the vote is called.
facetHighTitle: Dried Chili Threads
facetHigh: Two strangers in the elevator argue in circles about which floor. A third option, handed over on your way out, and they're left to act on it.
facetMidTitle: Oil on Dry Skin
facetMid: The market stall has a line going nowhere because nobody's sure it's open. You catch the vendor's eye and ask, loud enough for the rest to hear.
