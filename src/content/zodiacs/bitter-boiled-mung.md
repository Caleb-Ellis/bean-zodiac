...
fortuneHigh2: Spot-check the parts that matter and trust the rest.
fortuneMid: Two passes is the budget — recognise the costume on the third and walk away.
fortuneMid2: Check the start and the end, trust the middle.
fortuneLow: Send it out the door before you go over it once more.
fortuneLow2: Commit to it on the spot, standing up.
fortuneLeast: Let the small slip stand and the alarm chirp.
fortuneLeast2: Call it done the moment it technically is.
