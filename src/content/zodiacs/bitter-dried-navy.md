...
fortuneHigh: Pin it down in writing. The handshake rots; the named day keeps.
fortuneHigh2: You'll settle the debt by the date you set, in full, even when they've forgotten and would forgive the slip. People set their clocks by that.
fortuneMid: Make the exception once, and note why, so it doesn't quietly harden into a rule.
fortuneMid2: The plan that slipped a little can stay slipped this once. The method survives a small detour.
fortuneLow: Break your own protocol on purpose and watch what falls down. Nothing will — though bracing for the collapse is the hard part.
fortuneLow2: Promise one day, arrive the next, settle late without the apology. The friend across from you doesn't mind — even if the looseness gnaws at you.
...
The snag is the rule that has outlived its reason. They'll keep enforcing the policy no one remembers writing, hold the line on a principle whose original case has long since changed, and call it integrity rather than admit they've stopped asking what it was for.
