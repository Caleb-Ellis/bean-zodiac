...
fortuneMost: Refuse the polite exception. The "just this once" is the leak.
fortuneHigh: Send the calendar invite. Verbal agreements rot.
fortuneMid: Make the exception this once. Write down why so it doesn't become a rule.
fortuneLow: Break your own protocol once, deliberately, and see what falls down. Nothing will. The world has been holding the whole time.
fortuneLeast: Burn the spreadsheet. It was for a job you no longer have.
