...
fortuneHigh2: You'll settle the debt by the date you set, in full, even when they've forgotten and would forgive the slip.
fortuneMid: Make the exception once, and note why, so it doesn't quietly harden into a rule.
fortuneMid2: The plan that slipped a little can stay slipped this once.
fortuneLow: Break your own protocol on purpose and watch what falls down.
fortuneLow2: Promise one day, arrive the next, settle late without the apology.
fortuneLeast: That old rule was written for a life you no longer have.
fortuneLeast2: The version that walks out needn't match the one that walked in.
