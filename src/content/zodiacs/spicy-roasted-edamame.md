...
fortuneHigh2: A thing nobody will name is waiting for a voice.
fortuneMid: Season once and trust the heat.
fortuneMid2: The call you meant to make was right the first time.
fortuneLow: The quiet correction you stepped over is the green center worth going back for.
fortuneLow2: A truer answer sometimes surfaces only in the second draft.
