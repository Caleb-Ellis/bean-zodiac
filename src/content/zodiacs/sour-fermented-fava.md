...
fortuneMost: Disagree with everything and agreement stops meaning anything.
fortuneHigh: A crab walks sideways and gets there.
fortuneMid: The lone objection is worth hearing out.
fortuneLow: Go along with this one.
fortuneLeast: Agreeing is not surrender.
...
question: Everybody at the table has agreed the new one-way system is a disaster, especially the part by the school. You...
answerMost: argue for it, including the part by the school that nobody can defend
answerHigh: take the case nobody at the table will
answerMid: offer one thing in its favour and leave it at that
answerLow: say the part by the school is bad and the rest is fine
answerLeast: agree it's a disaster
