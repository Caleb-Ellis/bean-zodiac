...
fortuneMost: Add the next name to the old book in pen. The address you write now will be findable in twenty years.
fortuneHigh: Take three days, full sentences. They wrote to the slow version on purpose; don't deliver the fast one.
fortuneMid: Mend the lining. The coat improves by the patch in a way it could not improve by being new; the wear becomes the shape.
fortuneLow: Buy the chair this week. The slow accumulation has earned exactly one fast decision; this is it.
fortuneLeast: Answer the specific person, not the room. The general version is correct and is not reaching them.
