...
antiForm: dried
seasonalFortune: "A season of panisse and early moves — the pan is already doing tomorrow's work."
fortuneMost: The pika cuts hay for a distant winter, from fields it is not wanted.
fortuneHigh: The bag's packed and the coffee's made while the house is still dark.
...
Tempura Chickpeas are the Bean Zodiac's most proactive. The problem gets solved a fortnight before anyone else notices it exists. Sometimes they solve a problem that was somebody else's to solve. Waiting to be asked is not a posture available to them.
