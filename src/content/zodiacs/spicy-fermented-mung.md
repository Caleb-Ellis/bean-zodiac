...
fortuneMost: The compulsion is at full strength — find every gap in it and fill them differently.
...
fortuneHigh: The pull is real and the loop is running; find the space inside it.
...
fortuneMid: The loop is familiar — find the gap before returning, however small.
...
fortuneLow: Break the loop before the thread is lost — it is already running faster than anyone can follow.
...
fortuneLeast: Step out of it, even briefly; the loop is visible from outside, and what is seen is prompting distance.
---
