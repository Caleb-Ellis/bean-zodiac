...
fortuneMost: A sandpiper is gone before you've finished looking at it.
fortuneHigh: Answer and stop.
fortuneMid: The short version usually gets there.
fortuneLow: Give them the background too.
fortuneLeast: The long way round is where the story is.
...
question: You can send one message a day and it can only be six words long. You...
answerMost: use two of the six and let them work it out
answerHigh: get the whole point into the six
answerMid: use the six, and finish it off tomorrow
answerLow: spread it over two days so it's clear
answerLeast: take four days over it to get the background in
