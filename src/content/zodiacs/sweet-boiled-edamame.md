...
facetHigh: The volunteer rota falls apart every time someone flakes, so they hand you the unpopular early slot. You're there at dawn each turn, and the rota finally stops wobbling.
facetMidTitle: The Inbox by Evening
facetMid: Whatever the weather, whatever you're nursing, the dog gets its walk. Lead off the hook, same loop round the block, because the dog doesn't know it's a bad day for it.
facetLowTitle: The Chair That Migrates
facetLow: You take the same dull route to work out of pure habit, and a side street you've never tried branches off. Turn down it on a whim, late be damned, just to see where it goes.
facetLeastTitle: The Pot Left Before It Boils
facetLeast: You're halfway through a project you committed to and it's clearly going nowhere. Abandon it where it stands, no guilt, and chase the brighter idea that just walked in.
...
The shadow is that the reliability is almost too quiet to register. Nobody thanks the tap for working, and the bean has trained the room not to notice — so when something quietly starts costing them more than it used to, they never quite mention it, and the people who love them carry on assuming the tap will keep running.
