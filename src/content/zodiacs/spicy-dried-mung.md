...
facetHigh: Your replies land brief and warm-edged, affectionate enough to keep, pointed enough to recall by morning.
facetMidTitle: Heat Through the Dal
facetMid: You wait out a slight for days, then mention it once, plainly, at an hour no one expected.
facetLowTitle: Long on a Low Flame
