...
seasonalFortune: What replenishes the warmth will need to be found — not the place where nothing demands anything, but the source.
dailyNeutral: The depletion is real — let this one be quieter than usual.
dailyGood: Do less; the drain is the signal that replenishment is needed, and it should be listened to.
dailyBest: Go fully quiet — everything reduced to the minimum, and let the rest wait.
dailyBad: Show up more fully; the quietness is being read as disengagement and the gap is starting to matter.
