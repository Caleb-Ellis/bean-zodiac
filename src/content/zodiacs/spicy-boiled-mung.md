...
The shadow is that the watching is its own pot, kept at low boil for nothing. The package arrived on time, the call was fine, the worst-case never came — and somewhere in the cost column is a Tuesday spent half-here, half-bracing for a thing that wasn't ever going to happen.
