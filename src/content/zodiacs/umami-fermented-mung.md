...
fortuneHigh: When the news is hard, the one short sentence with one warm word in it is the medicine.
fortuneHigh2: You'll rework the three-line message until the rhythm sits, because cadence carries as much weight as the news.
fortuneMid: While the phrase gets worked into its final shape, the plain thing that needed saying stands waiting.
fortuneMid2: You'll rearrange a whole shelf until the objects rhyme.
fortuneLow: Say it as it comes — "thinking of you," nothing added — and it still arrives whole.
fortuneLow2: Eat the porridge while it's hot and don't pause to name the warmth.
fortuneLeast: A gentle sign this turn to put the body first — water, food, sleep, in that plain order.
fortuneLeast2: Handle the dull thing the day it lands, filed plain, no flourish in the margin.
...
The cost is the time it takes. While the phrase is being worked into its final shape, the friend is still standing in the rain, and the news that needed to be passed on plainly waits for a music it didn't strictly need.
