...
The catch is what efficiency does to the parts of life that weren't supposed to be tasks. A long lunch gets optimized; a slow conversation gets resolved; the friend across the table gets the version of them that was already mentally onto the next thing. They saved an hour. They aren't sure for what.
