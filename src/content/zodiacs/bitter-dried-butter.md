...
fortuneMost: Everything that does not belong has been stripped away — what is left is the truth of the thing.
...
fortuneHigh: The warmth is not needed here — let what remains stand on its own terms.
...
fortuneMid: Remove the comfort and see what holds beneath it.
...
fortuneLow: Add some warmth back in; not everything benefits from being stripped to the bone.
...
fortuneLeast: Make it comfortable — bare honesty is not serving anyone right now, and softness is not a lie.
---
