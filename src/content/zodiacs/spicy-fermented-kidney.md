...
fortuneHigh: The pass right after the one most people quit at is where it cracks open.
fortuneHigh2: Someone asks the polite question and you have the unhinged answer ready.
fortuneMid: When the asker actually wants the real version, skip the disclaimers and start where it gets good.
fortuneMid2: A pot can be left to settle overnight.
fortuneLow: The answer was good enough an hour ago, and you're still picking lint off an empty spool.
fortuneLow2: Leave the book at chapter four, already curious about the next thing.
fortuneLeast: When the thing's already closed and gone, finishing it now is only for you.
fortuneLeast2: Move the furniture, swap the route home, shuffle the playlist.
...
The catch is the sealed lid. Long after the answer was good enough, they're still in there refining it, mistaking the momentum for accuracy, and surfacing to a world that quietly moved on about a week ago.
