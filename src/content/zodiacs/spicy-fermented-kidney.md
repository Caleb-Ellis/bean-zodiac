...
fortuneMost: Everything belongs to the thing — give it completely, without remainder.
...
fortuneHigh: The obsession has earned its depth; run the full depth of it.
...
fortuneMid: The focus is real — give it the full weight of the day.
...
fortuneLow: Read the interest level honestly; the focus has outlasted it, and the depth is no longer welcome.
...
fortuneLeast: Let go of what absorbed you — the conversation has closed and something else is being asked for.
---
