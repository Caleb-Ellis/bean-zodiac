...
fortuneMid: The quiet objection spreads further than the loud one.
fortuneLow: Go along with the plan as written.
fortuneLeast: Doing as told is restful now and then.
facetMostTitle: B for Beandetta
...
question: The rules say every visitor signs the book in and out. Nobody has read the book in years, and it holds up the queue at the door every morning. You...
answerMost: put the book away in a drawer
answerHigh: stop signing people in
answerMid: sign in the visitors you don't know and wave the rest through
answerLow: take the book up with whoever wrote the rules
answerLeast: carry on signing people in
rorschachMost: a flag in shreds
rorschachHigh: a woodwormed beam
rorschachMid: a scrawled-on poster
rorschachLow: a mended fence
rorschachLeast: a clipped hedge
---
