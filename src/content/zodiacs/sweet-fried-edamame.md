...
facetHigh: A friend dreading their flat move opens the door to find you already there — van booked, boxes flattened in the back, a plan for which room gets cleared first.
facetMidTitle: Butter in the Blister
facetMid: A cupboard hinge has one loose screw. Before the thought's even finished, you're up with the screwdriver, just to have it squared away.
facetLowTitle: Glaze Gone Tacky
facetLow: That invitation's been sitting unanswered long enough that the trip's half-planned without you, and you're easy about it — if it's meant to include you, it'll come round again.
facetLeastTitle: Butter Gone Matte
facetLeast: The others want to walk the whole long empty beach end to end. Sink into the sand right here instead and let the tide do all the moving.
question: You wake up to a calm Saturday with nothing scheduled. You...
answerMost: have three errands done before the kettle's boiled
answerHigh: write a list and start on the most useful thing
...
Occasionally the propulsion outruns the question of what it was for. They look up at 4pm with the list finished and a small, unspecific worry about which item actually needed doing.
