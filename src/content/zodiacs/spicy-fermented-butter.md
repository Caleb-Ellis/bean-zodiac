...
fortuneMost: The odd thing you'd bring is the one worth bringing. Hand it over and let the strangeness stand.
fortuneMost2: The crock keeps its own hours and so do you. Luck is turning toward the work nobody asked for — sign it.
fortuneHigh: Don't file the edges down to a smooth thing. The people who lean toward the strange part are the ones worth keeping.
fortuneHigh2: Fold the weird small extra into the plain gift instead of swallowing it. A raised eyebrow is cheap; a thing that's yours is not.
fortuneMid: Leave the odd object where people pass it — no plaque, no pitch. The best conversations are the ones where they ask first.
fortuneMid2: A sourness that arrives sideways is still flavour. Take the slightly weirder choice; it'll keep tasting like you.
fortuneLow: You've been whispering the strange part. Say it plain once — the right ears can't lean toward a whisper they never heard.
fortuneLow2: Sometimes the safe choice really is the right one. Approve it quietly, flourish and all set aside.
fortuneLeast: Square the chairs, fold the napkins, let the place read clean. There's a real rest in not having to translate yourself.
fortuneLeast2: Pick the plainest option without a fight. You'll feel smaller choosing it and you're not — some days the angle can simply rest.
...
The catch is that they sometimes forget the angle is theirs alone. The gift lands odd, the suggestion lands sideways, and they're surprised when nobody quite picks it up — having long since stopped translating into the room's coordinates.
