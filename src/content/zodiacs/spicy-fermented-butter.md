...
fortuneHigh2: Fold the weird small extra into the plain gift instead of swallowing it.
fortuneMid: Leave the odd object where people pass it — no plaque, no pitch.
fortuneMid2: A sourness that arrives sideways is still flavour.
fortuneLow: You've been whispering the strange part.
fortuneLow2: Sometimes the safe choice really is the right one.
fortuneLeast: Square the chairs, fold the napkins, let the place read clean.
fortuneLeast2: Pick the plainest option without a fight.
