...
# SHOULD BE: trait rapt, excess abstracted, inverse dabbling
...
fortuneMost: The platypus was dismissed as a hoax for a hundred years.
fortuneHigh: Keep the weird bits.
fortuneMid: The odd idea turns out to be the useful one.
fortuneLow: Do one thing the normal way.
fortuneLeast: There's a reason everyone else does it like that.
facetMostTitle: Bean Freaks
...
facetLeastTitle: The Beany Line
...
question: Somebody asks what your mornings are like. What do you tell them?
answerMost: up at four, cold bath, an hour with the tortoise
answerHigh: your own order of things, and it would suit nobody but you
answerMid: mostly ordinary, with one bit people always query
answerLow: much the same as everybody's
answerLeast: exactly what you're meant to do, in the usual order
