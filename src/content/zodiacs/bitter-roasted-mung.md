...
fortuneMost: Moderate in all things and never quite in any of them.
fortuneHigh: A hedgehog eats what it finds and curls up on it.
fortuneMid: One glass is usually the right number.
fortuneLow: Have the second one.
fortuneLeast: Excess makes better stories.
facetMostTitle: Prohibeantion
...
facetLowTitle: Leaving Las Beanas
...
question: Last night of the trip, and the wine is out on the table. You...
answerMost: stop at one and go up before the plates are cleared
answerHigh: have two, and go up at a reasonable hour
answerMid: stay for the third and stop there
answerLow: stay at the table until the wine is finished
answerLeast: send somebody out for more wine at midnight
