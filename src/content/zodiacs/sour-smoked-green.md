...
The shadow is that the room learns the shape of the take before it learns the person. The argument is sound, the volume is the argument's volume, and a quieter point in the corner stops trying to find air.
