...
fortuneMost: Every step of it holds and the person across the table doesn't.
fortuneHigh: One reason is enough; two is gilding.
fortuneMid: A termite mound is engineered by nobody and stands.
fortuneLow: Loudness usually means something is at stake.
fortuneLeast: Sit with the people who can't solve it either.
...
facetLeastTitle: I Am the Beanus
...
question: Your brother has worked out how to have the car paid off by June — a spreadsheet, four months of overtime, and one month where the numbers don't meet. He's proud of it. You...
answerMost: walk him to the month that fails, and again when he moves on
answerHigh: show him the month that fails, and where the arithmetic goes wrong
answerMid: grant it works while the overtime holds, and ask what if it stops
answerLow: tell him it looks like a solid plan
answerLeast: back it, because he wants it enough
rorschachMost: a machine part
rorschachHigh: a flight of steps
rorschachMid: a wedge of cheese
rorschachLow: a bent nail
rorschachLeast: a chair with three legs
---
