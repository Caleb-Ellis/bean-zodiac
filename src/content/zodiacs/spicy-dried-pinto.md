...
fortuneMost: Asked for a little, you'll deliver a lot, and it'll be great.
fortuneMost2: A pot that keeps no quiet hour, throwing its heat against the lid from morning on.
fortuneHigh: Say the loud thing first and let the second telling stay quiet.
...
fortuneMid: Answer the question actually asked, not the three you prepared for.
fortuneMid2: Cook for the company at the heat they came for, not the heat you'd cook for yourself.
fortuneLow: Bring less than you packed.
fortuneLow2: The whole batch was for a hunger that isn't at this table.
fortuneLeast: Make the three-ingredient version.
fortuneLeast2: Not every ask is worth the whole tank, and learning which is which is the quiet art you've skipped.
...
question: The argument at the table has stopped being friendly, and you've got the line that would end it — true, and brutal. You...
answerMost: let it fly at full volume and don't soften a single word
answerHigh: say it sharp, then keep going while you've got the floor
answerMid: land the point hard, then catch yourself and ease off
answerLow: trim it to the fair half and leave the sting out
answerLeast: swallow it whole and steer the room somewhere calmer
