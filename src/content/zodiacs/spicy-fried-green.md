...
fortuneMost: Start now. The approval meeting later in the week becomes a demo, which is shorter and harder to lose than the meeting would have been.
fortuneHigh: Glance in the mirror once. Text the one person still keeping up; everyone else can find their own exit.
fortuneMid: Float the idea once and don't sell it. If it doesn't move on its own, it wasn't the right one — and the next one is already arriving.
fortuneLow: Pull over. Something said half an hour ago has been pinging the back of your skull — go back and answer it.
fortuneLeast: Take the slower route. Yours ends at a wall; theirs ends somewhere you can actually park.
