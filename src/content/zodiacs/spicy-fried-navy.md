...
fortuneMost: Plan the first hour of the next workday before you go to bed. Past-you is the only colleague who never misses a deadline.
fortuneHigh: Open the folder you've been routing around. The system is currently a way of not reading what's in it.
fortuneMid: Tell them the one small habit, not the framework. They'll only steal the small thing and the framework was for you.
fortuneLow: Call. The spreadsheet is doing a conversation's job and doing it badly.
fortuneLeast: Rip the labels off. You haven't lived on that shelf in a year and you're still maintaining it.
facetMostTitle: Jars Facing Out, Drawers Labeled
facetMost: You arrange a shelf the way a fritter sets in oil — each piece in its place, edges crisp, nothing touching by accident.
facetHighTitle: Inbox at Zero
facetHigh: Folders nested like spice tins, each message routed before it can pool — read, file, answer, close.
facetMidTitle: Oil at Temperature First
facetMid: You set tomorrow's first hour the night before, before the bean ever meets the pan.
facetLowTitle: Hot Sauce by Ear
facetLow: Paprika by handful, dinner loud — and the fritters come out anyway.
facetLeastTitle: Receipts in a Coat Pocket
facetLeast: Money moves through you like oil through a strainer — fast, ungoverned, and the month sorts itself out.
...
The catch is that the system, lovingly maintained, can outlive the thing it was built for. They are still labelling the shelf they stopped living on a year ago, still routing every message into a folder they no longer open.
