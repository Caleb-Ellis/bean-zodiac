...
facetMost: You name the date a thing will be done and arrive at it without renegotiation, even with yourself.
facetHighTitle: The Unwatched Hock
facetHigh: You answered the message on Tuesday because Tuesday was when you answered it; the contents barely entered the decision.
facetMidTitle: Smoke to the Rafters
facetMid: You leave the house at the same hour, take the same street, and notice the weather only after.
facetLowTitle: Lemon at the Last Minute
facetLow: You start the walk, see a lit window, and end the night somewhere you hadn't planned to be.
facetLeastTitle: The Hock Surrendered to Broth
facetLeast: You hold the plan loosely, swap it for a better one mid-sentence, and don't account for the swap later.
fortuneMost: The date stands. The 5am version of you trying to renegotiate is unqualified to vote.
fortuneHigh: Reply on the day you said you would, regardless of what arrived in the inbox after. The whole point of the schedule is that it doesn't read mail.
fortuneMid: Walk the usual street, but actually look up once. One glance is the whole new-information budget for this week — spend it.
fortuneLow: Someone amended the plan and you didn't read the amendment. Read it at the next corner, not at the destination.
