...
fortuneMost: The order gets followed long after it stopped making sense.
fortuneHigh: Leafcutter ants keep one path and the whole nest eats.
fortuneMid: A checklist earns its keep.
fortuneLow: Start in the middle for once.
fortuneLeast: Some of the best cooking is guesswork.
...
facetLowTitle: It's Always Beany in Philadelphia
...
facetLeastTitle: Arrested Beanelopment
...
question: You've got two hours to stocktake the shop before it opens. Where do you start?
answerMost: at the top of the list, and you stay on it when it stops helping
answerHigh: section by section, ticking each one off
answerMid: one end of the shop to the other
answerLow: whatever's nearest, with a tally as you go
answerLeast: whatever catches your eye, and add it all up at the end
