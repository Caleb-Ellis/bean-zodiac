...
The catch is that the cut tends to arrive before the patient has agreed to surgery. The point is correct, the timing is its own kind of wound, and the room takes longer to recover than the fix took to deliver.
