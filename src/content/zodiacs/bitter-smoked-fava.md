...
fortuneMost: Go all the way — into the territory no one else has charted, and bring back what only you can find.
...
fortuneHigh: Move further into it; what is found there cannot be reached any other way.
...
fortuneMid: Go where the others have not — that is what you are for.
...
fortuneLow: Find the common ground and meet them there; the distance is real, but the bridge is on your side.
...
fortuneLeast: Come all the way back — wherever you have been, the people here need you present, not translated.
---
