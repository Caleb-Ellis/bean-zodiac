...
facetMost: Hot oil keeps no secrets. The unsent message goes out before the batter cools — names attached, edges intact, no softening pass.
facetHigh: Bitter pepper sharpens the room. You walk into the disagreement straight on, while the others circle the pan looking for a cooler spot.
facetMid: The fritter sears where it meets metal. You let the slow ache in a shoulder speak plainly to a doctor instead of waiting it out another month.
facetLow: Akara, but mild. The thing that needs saying gets written down, set aside, and handled in a softer week — by then it has cooled to something workable.
facetLeast: The pepper stays in the jar. You rearrange the room around the loud houseguest, move the lamp, shift the chair, and never once name the noise.
---
