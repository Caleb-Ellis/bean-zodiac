...
But not every difficulty is a threat, and the front door is not always the door that opens easiest. Some things would have given way from the side with a gentle push, and these Beans walk away from a few rooms not quite sure whether they protected someone or just escalated something that was already cooling on its own.
