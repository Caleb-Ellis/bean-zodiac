...
fortuneHigh2: Two half-built things by midweek, a hand already reaching for the fifth.
fortuneMid: Hand the half-built thing to one trusted set of eyes, not the whole crowd.
fortuneMid2: Asked for one recipe, you send three with substitutions.
fortuneLow: Pick the one closest to done and finish it.
fortuneLow2: Make the one thing you came to make, then set the knife down.
fortuneLeast: No new pots.
fortuneLeast2: Let weeks pass between the things you finish, and don't apologise for the gap.
facetMostTitle: Bonito Past the Bowl
facetMost: The garden bed you filled in spring is already overflowing, and there's a fresh packet of seeds in your pocket and a bare strip of soil by the fence. You're crouched and digging the new row before the first crop is even picked.
facetHighTitle: The Second Dressing
facetHigh: A market stall, an empty Sunday, three projects already cluttering the shed at home — and on the way out, the wood for a fourth is somehow under your arm, hands itching to start before a single bench is clear.
facetMidTitle: The Crowded Colander
facetMid: Someone asks you for one good way to fix a squeaky hinge. Out come five methods, two of them improvised on the spot, before they've found the oil.
facetLowTitle: One Bean, Dressed
facetLow: One bowl was the plan, and one bowl is what you carry out — wheel still spinning, fresh clay right there, the hand that wants a second batch overruled.
facetLeastTitle: The Dashi, Untouched
facetLeast: A whole quiet fortnight passes with just one finished thing to show for it. Let the gap stand unexplained, even as the empty bench starts to itch.
...
The shadow is the bench. Somewhere in the crowd of warm pots is the one that needed another half hour, and it goes out the door at the same moment as everything else — slightly underdone, and forgotten by Friday because by then there are six new ones.
