...
By Tuesday they want a new one. The trouble isn't that the ideas run out; it's that the next one always arrives looking shinier than the unfinished one on the bench, and "I'm a starter, not a finisher" is a flattering way to say the same project keeps getting abandoned for its successor.
