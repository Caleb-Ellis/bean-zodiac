...
fortuneMost: Sprint the first yes. The other four yeses won't notice; they were never the point.
fortuneHigh: Talk to the stranger in the queue. You clocked them already; don't make it a story you tell later.
fortuneMid: Close the old tab before you open the new one. Both will taste better; one of them will get finished.
fortuneLow: You're three steps ahead and lapping the meeting. Sit down. Let them catch up.
fortuneLeast: One dim lamp, one empty hour, calendar cleared. That is the entire instruction.
