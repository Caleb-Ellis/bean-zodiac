...
fortuneMost: Reply "yes" or "no." The qualifier is theft.
fortuneHigh: Skip the agenda item. It will not be missed.
fortuneMid: Cut the meeting in half. Everyone is grateful, no one will say so.
fortuneLow: Add the why. The verdict without it sounds like a slam.
fortuneLeast: Tell the long story at dinner. Efficiency is not the point of the table.
