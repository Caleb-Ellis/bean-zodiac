...
facetHigh: Given the choice between the cheaper coat and the one that smells like something, you reach for the one that smells like something, every time.
facetMidTitle: Oil Where the Bean Splits
facetMid: When the body asks — sleep now, eat now, stop now — you answer it, and you do not negotiate the hour.
