...
answerMid: give roughly the same answer to both, with different emphasis
answerLow: tell both the same version, more or less word for word
answerLeast: use the exact same sentence and don't think about it twice
rorschachMost: a beetle and its reflection, each a different sheen
rorschachHigh: two moths, wings catching the light at odd angles
