...
fortuneMost: Say the sharp thing at dinner. Don't sand it on the way out of your mouth.
fortuneHigh: Pay the exact bill. Generosity rounded up is a bribe.
fortuneMid: One name on your list has been getting away with it for a while. Strike a line through it before bed; the list works better short.
fortuneLow: Their softer version isn't a lie. Pour the wine.
fortuneLeast: Skip the toast. Show up; that counts.
...
The trouble is the same instinct at a kinder table. A guest tells a slightly burnished version of a story and these Beans correct the figure before they've thought about it — a small accuracy nobody asked for, served warm, and the room goes a half-step quieter for the rest of the evening.
