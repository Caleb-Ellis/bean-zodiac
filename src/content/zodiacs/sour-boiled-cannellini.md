...
fortuneMost: The room will adjust to the standard; the standard does not adjust to the room.
...
fortuneHigh: Do not lower the bar because lowering it is easier than defending why it is where it is.
...
fortuneMid: The standard is correct — hold it even where holding it is inconvenient.
...
fortuneLow: Someone with authority thinks the bar is too high. This is not a great moment to die on that hill.
...
fortuneLeast: Let it go. The bar has already been moved and the people who moved it have decided they were right to do it.
---
...
Cannellini Beans are already particular about what they accompany; Sour Beans strip away sentiment; Boiled Beans refuse to rush.

The Brined Cannellini Bean's challenge is knowing when the standard serves the work. They must learn to distinguish between rigor and rigidity.
