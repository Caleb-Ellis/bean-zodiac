...
// Special cross-attribute pairings: bean+flavour, bean+form, or flavour+form.
// Checked across both zodiacs; total clamped to ±1.
...
export type SpecialCompatDetail = {
...
export const getSpecialCompatibility = (
  a: CompatSlice,
  b: CompatSlice,
): CompatibilityEntry =>
