...
export const getBeanCompatibility = (a: BeanId, b: BeanId): CompatibilityEntry => {
...
export const FLAVOUR_COMPATIBILITY = {
  ...
  "spicy-umami": {
    score: 0,
    label: "Wrong Moment",
    description: "One wants now. The other wants patience. They don't quite sync.",
  },
  "sweet-sweet": {
    score: -1,
    label: "Cloying",
...
export const getFlavourCompatibility = (a: FlavourId, b: FlavourId): CompatibilityEntry => {
...
export const getFormCompatibility = (a: FormId, b: FormId): CompatibilityEntry => {
...
export const TOTAL_COMPATIBILITY: Record<number, { label: string; description: string }> = {
  4: {
    label: "Bean Harmony",
    description: "Bean, flavour, and form all say the same thing. A once-in-a-cycle pairing.",
  },
  3: {
    label: "Full Flavour",
  ...
  "-4": {
    label: "Spoiled Batch",
    description: "Bean, flavour, and form all conflict. The rarest and most challenging match.",
  },
};
