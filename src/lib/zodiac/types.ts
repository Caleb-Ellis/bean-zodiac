...
// Spirit tags steer the Beanstalk's scoring pass: an entourage of 2 beans + 1
// form that moves alongside the zodiac's own triple, in whichever direction the
// tier and choice send it. Generated by scripts/generate-spirit-tags.py; looked
// up by zodiacId at score time (never read from persisted history). See lib/spiritBean.
