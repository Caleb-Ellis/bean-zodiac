      ...
      <defs>
        <filter id="form-roasted-filter" colorInterpolationFilters="sRGB">
          ...
          <feComposite
            ...
            in2="brownEroded"
            operator="out"
            result="brownEdgeHard"
          />
          <feGaussianBlur
            in="brownEdgeHard"
            stdDeviation={10}
            result="brownEdgeMask"
          />
          <feComposite
            in="brownColorized"
            in2="brownEdgeMask"
          ...
          <feComposite
            ...
            in2="blackEroded"
            operator="out"
            result="blackEdgeHard"
          />
          <feGaussianBlur
            in="blackEdgeHard"
            stdDeviation={6}
            result="blackEdgeMask"
          />
          <feComposite
            in="blackColorized"
            in2="blackEdgeMask"
        ...
        <filter id="form-fermented-filter" colorInterpolationFilters="sRGB">
          ...
          <feComposite
            ...
            in2="greenEroded"
            operator="out"
            result="greenEdgeHard"
          />
          <feGaussianBlur
            in="greenEdgeHard"
            stdDeviation={10}
            result="greenEdgeMask"
          />
          <feComposite
            in="greenColorized"
            in2="greenEdgeMask"
