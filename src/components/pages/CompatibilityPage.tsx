...
export default function CompatibilityPage({ data }: Props) {
  ...
  return (
    <>
      <section className="text-center py-8 pb-16">
        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight">
          Bean Compatibility
        </h1>
        <p className="mt-4 text-lg text-zinc-300 max-w-xl mx-auto">
          Find out if you simmer — or spoil
        </p>
      </section>
...
function DateField({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <DateInput value={value} onChange={onChange} className="w-full" />
    </div>
  );
}
