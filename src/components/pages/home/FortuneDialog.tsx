      ...
      <div className="max-w-xl w-full flex flex-col items-center gap-2">
        <div className="flex flex-col items-center gap-4">
          ...
          {fortuneZodiac ? (
            ...
            <div className="my-2 sm:my-3 h-5 w-44 bg-zinc-800 rounded-full animate-pulse" />
          )}
        </div>
        ...
        >
          <div className="relative w-full" style={{ perspective: "1400px" }}>
                ...
                >
                  ...
                  <div className="relative w-full rounded-[calc(1rem-1.5px)] bg-zinc-900 p-4 flex flex-col items-center gap-4">
                    ...
                    {!scored ? (
                      ...
                      >
                        {fortuneTitle ? (
                          <p className="font-bold text-zinc-200 animate-fade-up text-center">
                            {fortuneTitle}
                          </p>
                        ) : (
            ...
            >
              <div
                className={!revealed ? "animate-card-sway" : ""}
                style={{
              ...
              >
                <button
                  ...
                  disabled={revealed}
                  aria-hidden={revealed}
                  className="block px-6 py-3 text-sm tracking-[0.3em] uppercase text-zinc-100 hover:text-white border border-zinc-300/60 hover:border-zinc-100 rounded-full cursor-pointer bg-zinc-950/80 backdrop-blur-md shadow-xl shadow-black/80"
                  style={{
                    transform: "translateZ(60px)",
                    opacity: revealed ? 0 : 1,
                    transition:
                      "opacity 300ms ease, color 200ms, border-color 200ms",
                  }}
                >
                  Reveal
                </button>
