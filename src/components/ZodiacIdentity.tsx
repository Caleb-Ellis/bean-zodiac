...
export default function ZodiacIdentity({ data, date }: Props) {
      ...
      <section className="flex flex-col items-center gap-2">
        <h2 className="mb-2 flex flex-col items-center font-bold">
          ...
          <span className="block text-4xl sm:text-7xl mb-3 sm:mb-7">
            <span
              style={{
                background: `linear-gradient(135deg, var(--flavour-${flavour.slug}) 60%, var(--form-${form.slug}) 75%)`,
        ...
        <div className="flex flex-col items-center gap-3 max-w-xl">
          <p className="italic mb-1 sm:mb-2">"{zodiac.quote}"</p>
        </div>
      </section>
