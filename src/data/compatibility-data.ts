...
export const SPECIAL_COMPATIBILITY: Record<string, CompatibilityEntry> = {
  ...
  "butter-spicy": {
    ...
    description:
      "One steadies the heat. The other makes everything interesting.",
  },
  "cannellini-umami": {
    score: 1,
  ...
  "edamame-sour": {
    ...
    label: "No Excess",
    description:
      "Two forces that cut to the point. Nothing lingers that shouldn't.",
  },
  "fava-spicy": {
    score: 1,
    label: "Full Commitment",
    description:
      "One demands the work. The other demands attention. Nothing here is mild.",
  },
  "green-umami": {
    score: 1,
    label: "Early Promise",
    description:
      "The freshness opens a door the depth is still learning to walk through.",
  },
  "kidney-spicy": {
    score: 1,
    label: "Full Heat",
  ...
  "pinto-sour": {
    ...
    label: "Edited",
    description:
      "The acid cuts what the colour left unfinished. Better for it.",
  },
  // Bean + Form
  "adzuki-roasted": {
    score: 1,
  ...
  "boiled-butter": {
    ...
    label: "Deep Ease",
    description:
      "Patience meeting patience. Nothing is rushed. Everything is ready.",
  },
  "boiled-mung": {
    score: 1,
    label: "The Restorer",
  ...
  "cannellini-dried": {
    ...
    label: "Pure Form",
    description:
      "Both have removed what doesn't belong. What remains is immaculate.",
  },
  "chickpea-fried": {
    score: 1,
    label: "Open Door",
  ...
  "dried-edamame": {
    ...
    description:
      "Both have stripped away what doesn't serve. Clean and exactly enough.",
  },
  "dried-navy": {
    score: 1,
  ...
  "bitter-fermented": {
    ...
    label: "Dark Alchemy",
    description:
      "Both transform through complexity — neither for the casual palate.",
  },
  "roasted-sweet": {
    score: 1,
    label: "Abundance",
    description:
      "Both warm, both generous — something between them is always in excess.",
  },
};
...
> = {
  4: {
    label: "Bean Harmony",
    description:
      "Every axis aligns — including what no chart predicts. A once-in-a-cycle pairing.",
  },
  3: {
    label: "Full Flavour",
    description:
  ...
  "-3": {
    label: "Spoiled Batch",
    description:
      "Breakdown across every axis. The rarest and most challenging match.",
  },
};
